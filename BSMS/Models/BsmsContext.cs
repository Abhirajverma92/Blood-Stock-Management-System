...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;port=3306;user=root;password=root;database=bsms", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.2.0-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Donor>(entity =>
        {
            ...
            entity.HasIndex(e => e.Cityid, "dcityid_idx");
        ...
        modelBuilder.Entity<Receiver>(entity =>
        {
            ...
            entity.HasIndex(e => e.Bloodproductid, "bloodproductrec_idx");
            ...
            entity.HasOne(d => d.Bloodproduct).WithMany(p => p.Receivers)
                .HasForeignKey(d => d.Bloodproductid)
                .HasConstraintName("bloodproductrec");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasIndex(e => e.Roleid, "FKnjp9roe56nhgxjm2d5iuipbdr");
